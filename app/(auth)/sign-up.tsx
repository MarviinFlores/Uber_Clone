        ...
        >
          <View className="bg-white px-7 py-9 rounded-2xl min-h[300px]}">
            ...
            <Text className="font-Jakarta mb-5">
              Enviamos un codigo al mail {form.email}
            </Text>
        ...
        <ReactNativeModal isVisible={showSuccessModal}>
          <View className="bg-white px-7 py-9 rounded-2xl min-h-[300px]">
           <Image source={images.check} className="w-[110px] mx-auto my-5"/>
            ...
            <Text className="tex-base text-gray-400 font-Jakarta text-center mt-2">
            Verificacion Exitosa
             </Text>
            <CustomButton
              title = "Browse Home" onPress={()=> router.push("/(root)/(tabs)/home")} className="mt-5" />
          </View>
        </ReactNativeModal>
      </View>
    </ScrollView>
